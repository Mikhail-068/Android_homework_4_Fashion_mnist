package com.example.fashion_mnist.ml;
...
public final class FashionMnistRescaling {
  @NonNull
  private final Model model;

  private FashionMnistRescaling(@NonNull Context context, @NonNull Model.Options options) throws
      IOException {
    model = Model.createModel(context, "fashion_mnist_rescaling.tflite", options);
    MetadataExtractor extractor = new MetadataExtractor(model.getData());
  }

  @NonNull
  public static FashionMnistRescaling newInstance(@NonNull Context context) throws IOException {
    return new FashionMnistRescaling(context, (new Model.Options.Builder()).build());
  }

  @NonNull
  public static FashionMnistRescaling newInstance(@NonNull Context context,
      @NonNull Model.Options options) throws IOException {
    return new FashionMnistRescaling(context, options);
  }
